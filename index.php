...
<?php
    ...
    $query_total_payments = "SELECT SUM(order_cost) AS total_payments FROM orders WHERE order_status != 'not paid'";
    ...
    $query_total_paid = "SELECT COUNT(*) AS total_paid FROM orders WHERE order_status = 'delivering' OR order_status = 'paid' OR order_status = 'preparing'  OR order_status = 'done'";
                            ...
                            <div class="card border-top-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <i class="bx bxs-cart-download fa-2x text-blue-300"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo setRupiah($total_payments) ?></div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="bi bi-cash-coin fa-2x text-blue-300"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card border-top-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <i class="bi bi-journal-check fa-2x text-blue-300"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card border-top-danger shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <i class="bi bi-journal-x fa-2x text-blue-300"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
