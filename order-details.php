...
<section class="breadcrumb-option" style="background: #22223b; padding: 18px 0; border-radius: 12px; margin-bottom: 30px;">
    <div class="container">
        <div style="display: flex; align-items: center; gap: 12px; font-size: 17px;">
            ...
            <a href="index.php" style="color: #f2e9e4; background: #4a4e69; padding: 6px 16px; border-radius: 8px; text-decoration: none; font-weight: 500; transition: background 0.2s;">Account</a>
            <span style="color: #9a8c98;">&#10095;</span>
            ...
            <span style="color: #9a8c98;">&#10095;</span>
            <span style="color: #22223b; background: #f2e9e4; padding: 6px 16px; border-radius: 8px; font-weight: 600;">Detail Pesanan</span>
        </div>
    </div>
</section>
