...
<section class="breadcrumb-option" style="background: #1a1a2e; padding: 15px 0; margin-bottom: 30px;">
    <div class="container">
        <div style="display: flex; align-items: center; gap: 12px; font-size: 17px;">
            ...
            <span style="color: #22223b; background: #f2e9e4; padding: 6px 16px; border-radius: 8px; font-weight: 600;">Menu</span>
        </div>
    </div>
</section>
        ...
        <div class="container">
            <div class="row">
                <details class="details-dropdown" style="margin-left: 30px; ">
                    <summary role="button">
                        <a style="font-weight: 600; background-color: #1a1a2e; color: white; padding: 8px 20px; border-radius: 6px; text-decoration: none; transition: 0.3s; box-shadow: 0 2px 6px rgba(0,0,0,0.1);" class="button">Kategori</a>
                    </summary>
                ...
                <div style="margin-left: 6px; width: 982px;" class="shop__sidebar__search">
                    <form action="shop.php" method="POST">
                        ...
                        <button class="btn btn-info" style="background-color: #1a1a2e;" type="submit" name="cari"><img src="img/icon/search.png"  style="width: 12px;" alt=""></button>
                    </form>
                </div>
            </div>
                            ...
                            <div class="product__item">
                                ...
                                <div class="product__item__text">
                                    ...
                                    <form method="POST" action="shopping-cart.php">
                                        ...
                                        <button style="background-color: #1a1a2e; margin:5px" type="submit" name="add_to_cart" class="btn btn-info">Tambah ke Keranjang</button>
                                    </form>
                                </div>
                            </div>
                        </div>
